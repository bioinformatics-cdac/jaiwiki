...
import 'participant_details_model.dart';
export 'participant_details_model.dart';
...
class _ParticipantDetailsWidgetState extends State<ParticipantDetailsWidget> {
  late ParticipantDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParticipantDetailsModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ParticipantsRecord>(
      stream: ParticipantsRecord.getDocument(widget.participant!),
      builder: (context, snapshot) {
        ...
        final participantDetailsParticipantsRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
          appBar: AppBar(
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.textController1 ??=
                                    ...
                                    text: participantDetailsParticipantsRecord
                                        .name,
                                  ),
